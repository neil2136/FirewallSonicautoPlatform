...
import modules.CLI.external_collector
...
externalcollector1 = modules.CLI.external_collector.externalcollectorCli(fw)
...
external_collector_dict= {
        ...
        'port': '100',
        'reporting-format': 'ipfix-with-extension',
 ##report option #####
        #'open': False,
         'close': False,
        #'active-timeout': '0',
...
output1 = externalcollector1.config_external_collector(**external_collector_dict, tag=1)
print('333333')
print(output1)
print('333333')
