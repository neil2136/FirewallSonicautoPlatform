...
class UIHelper:
    ...
    def click_add_icon(self, label=None):
        try:
            ...
            if label is None:
                self.ui_wrapper.click_element('class', "icon-add")
            else:
                self.ui_wrapper.click_element('xpath', "//span[contains(@class, 'icon-add')]/following::span[contains(text(), '" + label + "')]")
    ...
    def click_close_icon(self):
        try:
            ...
            self.ui_wrapper.click_element('class', 'icon-close-thin')
        except Exception as err:
            logger.error("Exception \t: " + str(err))
    ...
    def click_delete_icon(self):
        try:
            ...
            self.ui_wrapper.click_element('class', "icon-trash")
        except Exception as err:
            logger.error("Exception \t: " + str(err))
    ...
    def accept_alert(self):
        try:
            ...
            self.ui_wrapper.click_element('xpath', '//div[contains(@class, "sw-confirm-modal__footer")]/div/div/button'
    ...
    def cancel_alert(self):
        try:
            ...
            self.ui_wrapper.click_element('xpath', '//div[contains(@class, "sw-confirm-modal__footer")]'
    ...
    def submit_page(self):
        try:
            ...
            self.ui_wrapper.click_element('xpath', '//div/button[text()="Save" or text()="Accept" or '
    ...
    def go_page(self):
        try:
            ...
            self.ui_wrapper.click_element('xpath', '//div/button[text()="GO"]')
        except Exception as err:
            logger.error("Exception \t: " + str(err))
    ...
    def cancel_page(self):
        try:
            logger.debug("Action - Clicking on Cancel button")
            self.ui_wrapper.click_element('xpath', '//div/button[text()="Cancel"]')
        except Exception as err:
            logger.error("Exception \t: " + str(err))
    ...
    def close_page(self):
        try:
            ...
            self.ui_wrapper.click_element('xpath', '//div/button[text()="Close"]')
        except Exception as err:
            logger.error("Exception \t: " + str(err))
    ...
    def go_back(self):
        ...
        self.ui_wrapper.click_element('xpath', '//div/span/span[contains(@class, "icon-go-back")]')
    ...
    def click_refresh_icon(self):
        try:
            ...
            self.ui_wrapper.click_element('class', "icon-refresh")
        except Exception as err:
            logger.error("Exception \t: " + str(err))
    ...
    def search_string(self, string_to_be_searched):
        try:
            ...
            self.ui_wrapper.click_element('class', "icon-search")
            getObject = self.ui_wrapper.get_element('xpath','//input[contains(@placeholder, "Search")]')
    ...
    def click_on_edit_element_after_hovering(self, row_identifier, modal=False):
        try:
            ...
            if modal is False:
                ...
                self.ui_wrapper.move_to_the_element('xpath',
    ...
    def wait_for_changes_made(self):
        try:
            ...
            self.ui_wrapper.wait_for_text("Changes made.")
            self.accept_alert()
            self.ui_helper.wait_for_page_data_to_be_rendered()
        except Exception as err:
            logger.error("Exception \t: " + str(err))
    ...
    def retrieve_info_icon_text(self, label):
        ...
        self.ui_wrapper.click_element('xpath', "//span[contains(text(), '"+label+"')]/following::*"
                                                                "[contains(@class, 'icon-info')]")
        elements = self.ui_wrapper.get_elements('xpath', "//div[contains(@class, 'sw-tooltip__inner')]//span")
        if len(elements) == 1:
            return elements[0]
        else:
            return elements
    ...
    def select_obj_drop_down_value(self, obj, field_val=None):
        try:
            ...
            obj.click()
            object = self.ui_wrapper.get_invisible_element('xpath', '//*[text() = "' + field_val + '"]')
            self.ui_wrapper.move_to_the_element(object)
            object.click()
        except Exception as err:
            logger.error("Exception \t: " + str(err))
            Assertion.fail("Action - Unable to select from drop down list")
    ...
    def filter_custom_data(self):
        try:
            ...
            self.ui_wrapper.click_element('class', "icon-filter")
            self.ui_wrapper.click_element('xpath', '//*[contains(text(),"Custom")]')
        except Exception as err:
            logger.error("Exception \t: " + str(err))
    ...
    def configure_radio_button(self, radio_button_label, group_name=None):
        try:
            ...
            if group_name is not None:
                ...
                self.ui_wrapper.click_element('xpath','//span[text()="'+radio_button_label+'"]')
    ...
    def configure_toggle_button(self, toggle_label, configure_value, group_name=None, modal=False, label=True, position=None):
        try:
            ...
            for xpath in xpath_list:
                if self.ui_wrapper.does_element_exist_now('xpath', xpath):
                    elements = self.ui_wrapper.get_elements('xpath', xpath)
                    element_status = True
                    if position is None:
                        position = 0
                    else:
    ...
    def configure_text_area(self, text_area_label, text_area_value):
        try:
            ...
            self.ui_wrapper.set_text_field('xpath', '//div[contains(@class,"text_area_label")]/span[text()="' + text_area_label + '"]/following::textarea', text_area_value)
        except Exception as err:
            logger.error("Exception \t: " + str(err))
    ...
    def compare_error_message(self, errorMsg):
        try:
            errorMessage = self.ui_wrapper.get_element('class', "sw-status-info__text__message")
    ...
    def import_file(self, import_label, file_path):
        try:
            ...
            self.ui_wrapper.move_to_the_element('class',
                                        'sw-file-upload')
            element = self.ui_wrapper.get_element('xpath',
    ...
    def get_text_field_value(self, text_box_label):
        try:
            ...
            ele = self.ui_wrapper.get_element('xpath',
    ...
    def get_text_field_value_by_attribute(self, text_box_label):
        try:
            logger.debug("Get - Text field  " + text_box_label + "  value ")
            ele = self.ui_wrapper.get_element('xpath','//div[contains(@class,"label") and text()="'+text_box_label+'"]/'
                                                    'following::input[@type="text" or @type="password"]|'
                                                    '//div[contains(@class, "label")]/span[text()="'+text_box_label+'"]/'
                                                    'following::input[@type="text" or @type="password"]|'
                                                    '//div[contains(@class, "label")]/span[contains(text(), "'+text_box_label+'")]/'
    ...
    def click_forward_tree_play_icon(self):
        try:
            ...
            self.ui_wrapper.click_element('xpath', "//div[@class='selector-middle']//*"
    ...
    def click_forward_play_icon(self):
        try:
            logger.debug("Action - Clicking Forward Play Icon")
            self.ui_wrapper.click_element('xpath', "//span[contains(@style, 'rotate(0deg);')]"
                                                   "//*[contains(@class, 'icon-play')]")
        except Exception as err:
            logger.error("Exception \t: " + str(err))
            Assertion.fail("Failed to click forward play icon")
    ...
    def click_reverse_select_icon(self):
        try:
            logger.debug("Action - Clicking Reverse Play Icon")
            self.ui_wrapper.click_element('xpath', "//span[contains(@style, 'rotate(180deg);')]"
                                                   "//*[contains(@class, 'icon-play')]")
        except Exception as err:
            logger.error("Exception \t: " + str(err))
            Assertion.fail("Failed to click reverse play icon")
    ...
    def verify_left_tree_value(self, tree_list):
        ...
        for tree_value in tree_list:
            if not self.ui_wrapper.does_element_exist('xpath', "//div[@class='selector-left']"
    ...
    def verify_right_tree_value(self, tree_list):
        ...
        for tree_value in tree_list:
            if not self.ui_wrapper.does_element_exist('xpath', "//div[@class='selector-right']"
                                                               "//*[contains(@class, 'sw-tree-list-item') "
                                                               "and text()='" + tree_value + "']"):
                return False
        return True
    ...
    def configure_checkbox_button(self, checkbox_label, configure_value):
        try:
            ...
            self.ui_wrapper.checkbox_button('xpath',
    ...
    def submit_modal(self):
        try:
            ...
            self.ui_wrapper.click_element('xpath', "//div[contains(@class, 'sw-modal--pillar') and @style!='display: none;']//button[text()='Accept']")
            self.ui_helper.wait_for_page_data_to_be_rendered()
        except Exception as err:
            logger.error("Exception \t: " + str(err))
    ...
    def cancel_modal(self):
        try:
            ...
            self.ui_wrapper.click_element('xpath', "//div[contains(@class, 'sw-modal--pillar') and @style!='display: none;']//button[text()='Cancel']")
            self.ui_helper.wait_for_page_data_to_be_rendered()
        except Exception as err:
            logger.error("Exception \t: " + str(err))
            Assertion.fail("Failed to click cancel button")
    ...
    def get_checkbox_value(self, select_identifier):
        try:
            ...
            time.sleep(1)
            ele = self.ui_wrapper.get_element('xpath',  "//div[contains(text(), '" + select_identifier +"')]"
