...
class AppFlow(Browser):
	...
	def go_to_users(self):
		...
		time.sleep(10)
		self.click_element('xpath',"/html/body/div/div/div[2]/div[2]/div[2]/div[1]/div/section/div/div[1]/div[1]/div/div[2]/div[1]/div/ul/li[2]/div/span")
		time.sleep(50)
	...
	def go_to_user_session_page(self):
		...
		try:
			...
			logger.info("No 'Device not registered' status message found, proceeding further...")
		logger.info("Login Test Flag.")
		logger.info("printing current page")
	...
	def set_logging(self):
		...
		time.sleep(5)
		result = self.is_element_enabled("xpath",
										 "/html/body/div/div/div[2]/div[2]/div[2]/div[1]/div/section/div/div[1]/div[2]/div/div/div/div[2]/div[2]/div/div[2]/div/div[2]/div[1]/div[2]/div/div/input")
		...
		time.sleep(5)
		result = self.is_element_enabled("xpath",
										 "/html/body/div/div/div[2]/div[2]/div[2]/div[1]/div/section/div/div[1]/div[2]/div/div/div/div[2]/div[2]/div/div[2]/div/div[4]/div[1]/div[2]/div/div/input")
		Assertion.assert_equal(result, True, "error: Log user name text box not enable")
