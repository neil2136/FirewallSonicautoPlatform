...
user_authen= {'method': {'radius': True },
              # 'method': 'local',
              # 'method': 'radius-local',
              # 'method': 'ldap',
              # 'method': 'ldap-local',
...
# aa = user_ldap.add_tacacs_server(**add_tacacs_server)
...
# aa = user_ldap.add_tacacs_account(**add_tacacs_account)
...
# For local user: 5 parts in it: user settings/user groups/vpn access/bookmark/ user quota
   # when you add/delete/edit for those three part:user groups/vpn access/bookmark, because of different api url,
   # 1.you must add a user firstly,
   # 2.and then add/delete/edit user groups/vpn access/bookmark
...
# aa = user_guest.show_user_guest_profile()

# aa = user_guest.show_user_guest_account()
