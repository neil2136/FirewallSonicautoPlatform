...
class WebproxyApi:
    ...
    def config_webproxy(self, msg=False, **kwargs):
        ...
        kwargs = self.options        
        json_input = self.build_json_webproxy(kwargs['server'], kwargs['port'], kwargs['bypass_upon_failure'], kwargs['forward_public_requests'])
...
class InterfaceIPv4Api:
    ...
    def config_vlan_interface_to_wiremode(self, msg=False, **kwargs):
        ...
        json_input['interfaces'][0]['ipv4']['ip_assignment']['mode']['wire_mode']['paired_interface_zone'] = kwargs['wire_paired_zone']
        json_input['interfaces'][0]['ipv4']['ip_assignment']['mode']['wire_mode']['paired_interface']['interface'] = kwargs['wire_paired_interface']
    ...
    def build_gre4to6_interface_json(self, **kwargs):
        ...
        try:
            ...
            input_json['tunnel_interfaces'][0]['4to6']['type']['gre4to6']['bound_to']['interface']=kwargs['bound_to_if'].upper()
    ...
    def add_dslite_tunnel_interface(self, msg=False, **kwargs):
        ...
        try:
            ...
            if "send_icmp_fragmentation" in kwargs:
                input_json['tunnel_interfaces'][0]['4to6']["send_icmp_fragmentation"] = kwargs["send_icmp_fragmentation"]
            if "comment" in kwargs:
                input_json['tunnel_interfaces'][0]['4to6']["comment"] = kwargs["comment"]
            input_json['tunnel_interfaces'][0]['4to6']['type'] = init_type_part
            input_json['tunnel_interfaces'][0]['4to6']['type']["dslite"]['bound_to']['interface']=kwargs['bound_to_if'].upper()
    ...
    def add_v6plus_tunnel_interface(self, msg=False, **kwargs):
        '''
        params example:
        opt = {
            "name": "JPIX_v6Plus_t1",
            ...
            "local": {"dynamic": True},
            "remote": {"dynamic": True},
            "comment":"JPIX v6plus tunnel interface"
            "update_url": ""
            "update_url_period": "60"
        }
        '''
        input_json = copy.deepcopy(self.initial_4to6_json)
        init_type_part = {
        ...
        try:
            ...
            if "comment" in kwargs:
                input_json['tunnel_interfaces'][0]['4to6']["comment"] = kwargs["comment"]
            input_json['tunnel_interfaces'][0]['4to6']['type'] = init_type_part
            input_json['tunnel_interfaces'][0]['4to6']['type']["v6plus"]['bound_to']['interface'] = kwargs[
                'bound_to_if'].upper()
            input_json['tunnel_interfaces'][0]['4to6']['type']["v6plus"]['local'] = kwargs['local']
            input_json['tunnel_interfaces'][0]['4to6']['type']["v6plus"]['remote'] = kwargs['remote']
            input_json['tunnel_interfaces'][0]['4to6']['type']["v6plus"]['update_url'] = kwargs['local']
            input_json['tunnel_interfaces'][0]['4to6']['type']["v6plus"]['update_url_period'] = kwargs['remote']
            if 'local_ipv4' in kwargs:
                input_json['tunnel_interfaces'][0]['4to6']['type']["v6plus"]["local_ipv4"] = kwargs['local_ipv4']
            if 'update_url' in kwargs:
                input_json['tunnel_interfaces'][0]['4to6']['type']["v6plus"]["update_url"] = kwargs['update_url']
            if 'update_url_period' in kwargs:
                input_json['tunnel_interfaces'][0]['4to6']['type']["v6plus"]["update_url_period"] = kwargs['update_url_period']
        except Exception as e:
            logger.error(repr(e))
        return self.fw.api_post(self.url_tunnel_4to6, msg, data=input_json)

    def edit_v6plus_tunnel_interface_by_name(self, tunnel_name=None, msg=False, **kwargs):
        '''
        param tunnel_name must be specified, others are optional
        params example:
        opt = {
        ...
        '''
        if not tunnel_name:
            logger.error('tunnel interface name must be specified!!')
        url = self.url_tunnel_4to6+'/name/'+tunnel_name
        input_json = self.get_tunnel_interface_status(name=tunnel_name, type='4to6')
        input_json['tunnel_interfaces'][0]['4to6'].update(kwargs)
        if "update_url" in kwargs:
        ...
        if 'local_ipv4' in kwargs:
            input_json['tunnel_interfaces'][0]['4to6']['type']['v6plus']['local_ipv4'] = kwargs['local_ipv4']
        if 'bound_to_if' in kwargs:
            input_json['tunnel_interfaces'][0]['4to6']['type']['v6plus']['bound_to']['interface'] = kwargs['bound_to_if']
        if 'local' in kwargs:
            input_json['tunnel_interfaces'][0]['4to6']['type']['v6plus']['local'] = kwargs['local']
        if 'remote' in kwargs:
            input_json['tunnel_interfaces'][0]['4to6']['type']['v6plus']['remote'] = kwargs['remote']
    ...
    def build_json_wan(self, **kwargs):
        ...
        try:
            ...
            if kwargs['mode'] == 'static':
                ...
                wiremode_json_input['interfaces'][0]['ipv4']['ip_assignment']['mode'] = self._get_interface_wiremode(**kwargs)
                ...
                logger.error('Make sure wan mode {} is one of: static, pptp, l2tp, wire-mode, tap-mode, pppoe, dhcp.'.format(kwargs['mode']))
                return False 
            json_input['interfaces'][0]['ipv4']['name'] = kwargs['if']
            ...
            if (not kwargs['user_http'] and kwargs['user_https']) or ('mgmt_http' in kwargs.keys() and not kwargs['mgmt_http'] and kwargs['mgmt_https']):
    ...
    def build_json_lan(self, **kwargs):
        ...
        try:
            ...
            if kwargs['mode'] == 'static':
                ...
                json_input['interfaces'][0]['ipv4']['ip_assignment']['mode'] = self._get_interface_lan_unnumber(**kwargs)
            elif kwargs['mode'] == 'l2bridge':
                json_input = copy.deepcopy(self.initial_ipv4_l2bridge_json)
                json_input['interfaces'][0]['ipv4']['ip_assignment']['zone'] = kwargs['zone']
                json_input['interfaces'][0]['ipv4']['ip_assignment']['mode'] = self._get_interface_lan_l2bridge(**kwargs)
            elif kwargs['mode'] == 'wire-mode':
                wiremode_json_input = copy.deepcopy(self.initial_ipv4_safemode_json)
                wiremode_json_input['interfaces'][0]['ipv4']['ip_assignment']['zone'] = kwargs['zone']
                ...
                json_input['interfaces'][0]['ipv4']['ip_assignment']['mode'] = self._get_interface_lan_portshield(**kwargs)
                json_input['interfaces'][0]['ipv4'].pop('management')
                json_input['interfaces'][0]['ipv4'].pop('user_login')
            elif kwargs['mode'] == 'transparent':
                json_input['interfaces'][0]['ipv4']['ip_assignment']['mode'] = self._get_interface_transmode(**kwargs)
    ...
    def build_json_wlan(self, **kwargs):
        ...
        try:
            ...
            if kwargs['mode'] == 'static':
                ...
                logger.error('Make sure wlan mode {} is one of: static, l2bridge, portshield, nativebridge.'.format(kwargs['mode']))
                return False
    ...
    def build_json_vpntunnel(self, **kwargs):
        ...
        try:
            ...
            if 'netmask' in kwargs.keys():
                json_input['tunnel_interfaces'][0]['vpn']['ip_assignment']['mode']['static']['netmask'] = kwargs['netmask']
            else:
                json_input['tunnel_interfaces'][0]['vpn']['ip_assignment']['mode']['static']['netmask'] = '255.255.255.0'
    ...
    def get_vlan_interface_address(self, name=None, vlan=None, version='v4'):
        url_tmp = 'api/sonicos/reporting/interfaces/'
        if version == 'v4':
            url_tmp = url_tmp + 'ipv4/ip'
        else:
        ...
        if name and vlan:
            ...
            logger.error('interface name and vlan shoule be specified for get_vlan_interface_address.')
            return False
        logger.info(url_tmp)
        resp = self.fw.api_get(url_tmp)
        return resp
        ...
        if object_type == "fqdn":
            ...
            if "," not in value:
                ...
                try:
                    ...
                    if subnet_ip == "0.0.0.0" and netmask_ip == "0.0.0.0":
                        logger.info("Info: Both subnet and netmask are default address 0.0.0.0, skipping comparison")
                        ipv_type = 'ipv4'
                    else:
    ...
    def build_json_address_group(self,group_type = None, mac_fqdn_type = None,**address_group):
        ...
        if group_type == "":
            ...
            if group_type == "ipv6":
                ...
                json_input['address_group']['ipv6']['address_object']['ipv6'] = json_input['address_group']['ipv6']['address_object']['ipv4']
                json_input['address_group']['ipv6']['address_group']['ipv6'] = json_input['address_group']['ipv6']['address_group']['ipv4']
...
class InterfaceIPv6Api:
    ...
    def config_ipv6_static_prefix(self, msg=False, **kwargs):
        ...
        try:
            ...
            json_input['interfaces'][0]['ipv6']['ip_assignment']['mode']['static']['router_advertisement']['prefix'][0]['prefix'] = kwargs['prefix'].upper()
            json_input['interfaces'][0]['ipv6']['ip_assignment']['mode']['static']['router_advertisement']['prefix'][0]['valid_lifetime'] = kwargs['valid_lt']
            json_input['interfaces'][0]['ipv6']['ip_assignment']['mode']['static']['router_advertisement']['prefix'][0]['preferred']['lifetime'] = kwargs['prefer_lt']
            if 'autonomous' in kwargs:
                json_input['interfaces'][0]['ipv6']['ip_assignment']['mode']['static']['router_advertisement']['prefix'][0]['autonomous'] = kwargs['autonomous']
            if 'on_link' in kwargs:
                json_input['interfaces'][0]['ipv6']['ip_assignment']['mode']['static']['router_advertisement']['prefix'][0]['on_link'] = kwargs['on_link']
        except Exception as e:
            print(e)
            ...
            if kwargs['mode'] == 'auto':
                ...
                if 'prefix_delegation' in kwargs['dhcpv6'].keys() and kwargs['dhcpv6']['prefix_delegation']:
                    ...
                    if 'preferred_delegated_prefix' in kwargs['dhcpv6'].keys():
                        json_input['interfaces'][0]['ipv6']['ip_assignment']['mode']['dhcpv6']['prefix_delegation']['preferred']['addr'] = kwargs['dhcpv6']['preferred_delegated_prefix_addr']
                        json_input['interfaces'][0]['ipv6']['ip_assignment']['mode']['dhcpv6']['prefix_delegation']['preferred']['prefix'] = kwargs['dhcpv6']['preferred_delegated_prefix_prefix']
                    if 'send_hints' in kwargs['dhcpv6'].keys():
                        json_input['interfaces'][0]['ipv6']['ip_assignment']['mode']['dhcpv6']['prefix_delegation']['send_hints'] = kwargs['dhcpv6']['send_hints']
                json_input['interfaces'][0]['ipv6']['ip_assignment']['mode']['dhcpv6']['rapid_commit'] = kwargs['dhcpv6']['rapid_commit']
                ...
                json_input['interfaces'][0]['ipv6']['ip_assignment']['mode']['dhcpv6']['aftr_name_option'] = kwargs['dhcpv6']['aftr_name_option']
                ...
                if 'prefix_length' in kwargs.keys():
                    json_input['interfaces'][0]['ipv6']['ip_assignment']['mode']['static']['prefix_length'] = kwargs['prefix_length']
                if 'adv_pref' in kwargs.keys():
                    json_input['interfaces'][0]['ipv6']['ip_assignment']['mode']['static']['advertise_subnet_prefix'] = kwargs['adv_pref']
                if 'router_adv' in kwargs.keys():
                    json_input['interfaces'][0]['ipv6']['ip_assignment']['mode']['static']['router_advertisement']['enable'] = kwargs['router_adv']
                if 'ra_min' in kwargs.keys():
                    json_input['interfaces'][0]['ipv6']['ip_assignment']['mode']['static']['router_advertisement']['interval']['min'] = kwargs['ra_min']
                if 'ra_max' in kwargs.keys():
                    json_input['interfaces'][0]['ipv6']['ip_assignment']['mode']['static']['router_advertisement']['interval']['max'] = kwargs['ra_max']
                if 'link_mtu' in kwargs.keys():
                    if kwargs['link_mtu'] == 0:
                        json_input['interfaces'][0]['ipv6']['ip_assignment']['mode']['static']['router_advertisement']['link_mtu'] = {}
                    else:
                        json_input['interfaces'][0]['ipv6']['ip_assignment']['mode']['static']['router_advertisement']['link_mtu']['value'] = kwargs['link_mtu']
                if 'reach_time' in kwargs.keys():
                    if kwargs['reach_time'] == 0:
                        json_input['interfaces'][0]['ipv6']['ip_assignment']['mode']['static']['router_advertisement']['reachable_time'] = {}
                    else:
                        json_input['interfaces'][0]['ipv6']['ip_assignment']['mode']['static']['router_advertisement']['reachable_time']['value'] = kwargs['reach_time']
                if 'retrans_time' in kwargs.keys():
                    if kwargs['retrans_time'] == 0:
                        json_input['interfaces'][0]['ipv6']['ip_assignment']['mode']['static']['router_advertisement']['retransmit_timer'] = {}
                    else:
                        json_input['interfaces'][0]['ipv6']['ip_assignment']['mode']['static']['router_advertisement']['retransmit_timer']['value'] = kwargs['retrans_time']
                if 'current_hop_limit' in kwargs.keys():
                    json_input['interfaces'][0]['ipv6']['ip_assignment']['mode']['static']['router_advertisement']['current_hop_limit']['value'] = kwargs['current_hop_limit']
                if 'lifetime' in kwargs.keys():
                    if kwargs['lifetime'] == 0:
                        json_input['interfaces'][0]['ipv6']['ip_assignment']['mode']['static']['router_advertisement']['router']['lifetime'] = {}
                    else:
                        json_input['interfaces'][0]['ipv6']['ip_assignment']['mode']['static']['router_advertisement']['router']['lifetime']['value'] = kwargs['lifetime']
                if 'managed' in kwargs.keys():
                    json_input['interfaces'][0]['ipv6']['ip_assignment']['mode']['static']['router_advertisement']['managed'] = kwargs['managed']
                if 'other_config' in kwargs.keys():
                    json_input['interfaces'][0]['ipv6']['ip_assignment']['mode']['static']['router_advertisement']['other_config'] = kwargs['other_config']
                ...
                if 'dns' in kwargs.keys():
                    ...
                    if 'primary' in kwargs['dns'].keys():
                        json_input['interfaces'][0]['ipv6']['ip_assignment']['mode']['static']['dns']['primary'] = kwargs['dns']['primary']
                    if 'secondary' in kwargs['dns'].keys():
                        json_input['interfaces'][0]['ipv6']['ip_assignment']['mode']['static']['dns']['secondary'] = kwargs['dns']['secondary']
                    if 'tertiary' in kwargs['dns'].keys():
                        json_input['interfaces'][0]['ipv6']['ip_assignment']['mode']['static']['dns']['tertiary'] = kwargs['dns']['tertiary']
                if 'gateway' in kwargs.keys():
                    json_input['interfaces'][0]['ipv6']['ip_assignment']['mode']['static']['gateway'] = kwargs['gateway']
                if 'advertise_subnet_prefix' in kwargs.keys():
                    json_input['interfaces'][0]['ipv6']['ip_assignment']['mode']['static']['advertise_subnet_prefix'] = kwargs['advertise_subnet_prefix']
        except Exception as e:
            print(e)
    ...
    def build_json_ipv6_tunnel_interface(self, **kwargs):
        ...
        try:
            ...
            if kwargs['type'] == 'manual':
                ...
                json_input['tunnel_interfaces'][0]['ipv6']['type']['manual']['prefix_length'] = int(kwargs['prefix_length'])
                ...
                json_input['tunnel_interfaces'][0]['ipv6']['type']['manual']['remote']['ipv4_address'] = kwargs['ipv4_address']
                json_input['tunnel_interfaces'][0]['ipv6']['type']['manual']['remote']['ipv6_network'] = kwargs['ipv6_network']
                ...
                json_input['tunnel_interfaces'][0]['ipv6']['type']['6rd']['prefix_length'] = int(kwargs['prefix_length'])
                ...
                if not kwargs['dynamic']:
                    ...
                    json_input['tunnel_interfaces'][0]['ipv6']['type']['6rd']['6rd']['prefix_length'] = kwargs['6rd_prefix_length']
                    json_input['tunnel_interfaces'][0]['ipv6']['type']['6rd']['border_relay_ipv4_address'] = kwargs['border_relay_ipv4_address']
                ...
                json_input['tunnel_interfaces'][0]['ipv6']['type']['gre']['prefix_length'] = int(kwargs['prefix_length'])
                json_input['tunnel_interfaces'][0]['ipv6']['type']['gre']['bound_to'] = kwargs['bound_to']
                json_input['tunnel_interfaces'][0]['ipv6']['type']['gre']['remote'] ={}
                json_input['tunnel_interfaces'][0]['ipv6']['type']['gre']['remote']['ipv4_address'] = kwargs['ipv4_address']
                json_input['tunnel_interfaces'][0]['ipv6']['type']['gre']['remote']['ipv6_network'] = kwargs['ipv6_network']
    ...
    def edit_network_monitor_ipv4(self,msg=False, **kwargs):
        ...
        if kwargs["probe_type"] == "ping_non_explicit":
            ...
            if "tcp_port" not in kwargs.keys():
                ...
                json_input["network_monitors"][0]["policy"]["ipv4"]["probe"]["type"].update({"tcp": {"port": kwargs["tcp_port"], "non_explicit": True}})
            ...
            if "outbound_interface" in kwargs.keys() and "tcp_port" in kwargs.keys():
                json_input["network_monitors"][0]["policy"]["ipv4"].update(
                    {"outbound_interface": kwargs["outbound_interface"]})
                json_input["network_monitors"][0]["policy"]["ipv4"]["probe"]["type"].update({"tcp": {"port": kwargs["tcp_port"], "explicit": True}})
            else:
                logger.error(
        ...
        if 'interval_successful' in kwargs.keys():
            json_input["network_monitors"][0]["policy"]["ipv4"]["interval"]["successful"] = kwargs["interval_successful"]
...
class DnsSettingsApi:
    ...
    def edit_ipv4_dns(self,msg=False,**kwargs):
        '''Arno Hu'''
        json_input = self.build_ipv4_dns_json( **{**DnsSettingsApi.dns_options, **kwargs})
        resp = self.fw.api_put(self.url, msg, data=json_input)
        return resp
    ...
    def show_dns_proxy_entries(self):
        show_resp = self.fw.api_get(self.split_dns_url)
        return show_resp
    ...
    def build_json_split_dns(self, **kwargs):
        ...
        try:
            ...
            if 'secondary' in kwargs['ipv4'].keys() and kwargs['ipv4']['secondary']:
                json_input['dns']['split_entry'][0]['server']['ipv4']['secondary']['value'] = kwargs['ipv4']['secondary']
            ...
            if 'secondary' in kwargs['ipv6'].keys() and kwargs['ipv6']['secondary']:
                json_input['dns']['split_entry'][0]['server']['ipv6']['secondary']['value'] = kwargs['ipv6']['secondary']
    ...
    def add_dns_proxy_entry(self, msg=False, **kwargs):
        ...
        try:
            ...
            if 'ipv4_primary' in kwargs:
                ...
                json_input['dns_proxy']['cache_entry'][0]['address']['ipv4']['primary']['value'] = kwargs['ipv4_primary']
            if 'ipv4_secondary' in kwargs:
                json_input['dns_proxy']['cache_entry'][0]['address']['ipv4']['secondary'] = {}
                json_input['dns_proxy']['cache_entry'][0]['address']['ipv4']['secondary']['value'] = kwargs['ipv4_secondary']
            if 'ipv6_primary' in kwargs:
                json_input['dns_proxy']['cache_entry'][0]['address']['ipv6']['primary'] = {}
                json_input['dns_proxy']['cache_entry'][0]['address']['ipv6']['primary']['value'] = kwargs['ipv6_primary']
            if 'ipv6_secondary' in kwargs:
                json_input['dns_proxy']['cache_entry'][0]['address']['ipv6']['secondary'] = {}
                json_input['dns_proxy']['cache_entry'][0]['address']['ipv6']['secondary']['value'] = kwargs['ipv6_secondary']
...
class IpHelperApi:
    ...
    def add_iphelper_policy(self, msg=False, **kwargs):
        ...
        if 'protocol' not in kwargs.keys() and ('source' not in kwargs.keys() or 'src' not in kwargs.keys()) and ('destination' not in kwargs.keys() or 'dsn' not in kwargs.keys()):
    ...
    def del_policy(self, **kwargs):
        if 'zone' in kwargs.keys():
            url = 'api/sonicos/ip-helper/policies/protocol/' +kwargs['protocol'].upper() + '/source/zone/' + kwargs['zone'].upper()
        if 'interface' in kwargs.keys():
            url = 'api/sonicos/ip-helper/policies/protocol/'+kwargs['protocol'].upper()+'/source/interface/'+kwargs['interface'].upper()
        rc = self.fw.api_delete(url)
        return rc
...
class NeighborDiscoveryApi:
    ...
    def edit_static_entry(self, msg=False, **kwargs):
        ...
        if 'mac' not in kwargs:
            kwargs['mac'] = kwargs['mac_old']
        if 'interface' not in kwargs:
            kwargs['interface'] = kwargs['interface_old']
        json_input = self.build_ndp_json(**kwargs)
    ...
    def delete_cache_entry(self, msg=False, **kwargs):
        if 'ip' not in kwargs or 'interface' not in kwargs:
            logger.error('Please specify both IP and Interface when deleting cache entry')
            return False
        delete_cache_url = self.url_cache_entry + f"/ip/{kwargs['ip']}/interface/{kwargs['interface']}"
        resp = self.fw.api_delete(delete_cache_url, msg)
        return resp

    def show_NDP_setting(self):
        setting_resp = self.fw.api_get(self.url_setting)
        return setting_resp
                        ...
                        "ipv4":
                            {
                                ...
                                "offline_settings":{}#do_nothing:true,use_previous:true,make_host_unknown:true,manual:1.1.1.1
                        }
                    }
                }
            ]
...
class DNSSecurityApi:
    ...
    def enable_dns_sinkhole(self, msg=False, **kwargs):
        ...
        try:
            if kwargs['action'] == 'dropping_with_logs' or  kwargs['action'] == 'dropping_with_negative_dns_reply_to_source':
                ...
                logger.error('Please specify action to one of dropping_with_logs,dropping_with_negative_dns_reply_to_source or dropping_with_dns_reply_of_forged_ip')
                return False
...
class DynamicRoutingApi:
    ...
    def set_rip(self, msg=False, **kwargs):
        ...
        elif 'type' in kwargs and kwargs['type'] == 'TI' and 'tunnel_id'in kwargs.keys():
            index = kwargs['tunnel_id']
        else:
            index = kwargs['interface'].replace('X','')
        cgi='cgiaction=undefined&tableIndex=' + index + '&refresh_page=newRoutePolicies.html&auditPath=MONITOR+%2F+Network+%2F+Routing+%2F+Interface+' + kwargs['interface'] + '+%28DMZ%29+RIP+Configuration&'
        mode = {
            'disable': '0',
            'send_and_receive' : '1',
            'send': '2',
        ...
        if rip_mode != '0' and rip_mode != 4:
            ...
            if rip_mode == '1' or rip_mode =='2':
                cgi += 'ZRipSplitH=' + kwargs['split_horizon'] + '&ZRipPoisonR=' + kwargs['poison_reverse'] + '&ZRipSMode=' + kwargs['send'] + '&'
    ...
    def set_ripng(self, msg=False, **kwargs):
        ...
        cgi +=f'auditPath=MONITOR+%2F+Network+%2F+Routing+%2F+Interface+' + kwargs['interface'] + f'+%28{kwargs["zone"]}%29+RIPng+Configuration'
        self.default_cgi['stream'] = cgi
        res = self.fw.api_post(self.url, msg, data=self.default_cgi,headers=self.headers)
        return res   
...
11&ZOspfArea=112&ZOspfAreaType=0&ZOspfIfAutoCost=on&ZOspfIfPriority=1&ZOspfIfIgnoreMtu=off&cbox_ZOspfIfIgnoreMtu=&cbox_ZOspfIfAutoCost=&auditPath=MONITOR
        ...
        cgi += 'auditPath=MONITOR+%2F+Network+%2F+Routing+%2F+Interface+' + kwargs['interface'] + '+%28WAN%29+OSPFv2+Configuration'
        self.default_cgi['stream'] = cgi
        res = self.fw.api_post(self.url, msg, data=self.default_cgi,headers=self.headers)
        return res
...
class VLANTranslationApi:
    ...
    def edit_vlan_translation(self,msg = False,**kwargs):
        json_input = self.build_vlan_translation(**kwargs)
        url = self.url + '/ingress/interface/' + kwargs['old_ingress_interface'] + '/vlan/' + str( kwargs['old_ingress_vlan']) + '/egress/interface/' + kwargs['old_egress_interface'] + '/vlan/' +  str(kwargs['old_egress_vlan'])
        resp = self.fw.api_put(url, msg, data=json_input) 
        return resp
