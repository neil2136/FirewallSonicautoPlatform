...
sys.path.append(os.environ["PYTHON_SONICOS_HOME"] + '/User/Multi_factor_auth_otp_mail/testcases')
sys.path.append(os.environ["PYTHON_SONICOS_HOME"] + '/User/Multi_factor_auth_otp_mail')
sys.path.append(os.environ["PYTHON_SONICOS_HOME"] + '/User/Multi_factor_auth_otp_mail/lib/')
...
X2_IP = '14.1.1.168'
MASK = '255.255.255.0'
TESTPLAN = os.environ["PYTHON_SONICOS_HOME"] + '/User/Multi_factor_auth_otp_mail/testplan/testplan.json'
config_path = os.environ["PYTHON_SONICOS_HOME"] + "/User/Multi_factor_auth_otp_mail/config"
ip = FIREWALL
