...
sys.path.append(os.environ["PYTHON_SONICOS_HOME"] +'/User/Guest_Admin2/lib')
sys.path.append(os.environ["PYTHON_SONICOS_HOME"] +'/sslvpn/common_lib')
import ui_group
...
class Parameter():
    ...
    X1_IP = '13.0.0.100'
    X1_GW = '13.0.0.1'
    TESTPLAN = os.environ["PYTHON_SONICOS_HOME"] + '/User/Guest_Admin2/testplan/Guest_Admin-TP2592.json'
...
user_settings = system.AdminApi(fw_api)
ui_obj = ui_group.UI_Test()
