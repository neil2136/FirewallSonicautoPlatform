...
class Parameter():
    ...
    X1_IP = '13.0.0.100'
    X1_GW = '13.0.0.1'
    TESTPLAN = os.environ["PYTHON_SONICOS_HOME"] + '/User/CLDR-Feature/Setting_New_Password/Setting_Pwd_For_Built_in_Admin/testplan/setting_pwd_for_built_in_admin.json'
