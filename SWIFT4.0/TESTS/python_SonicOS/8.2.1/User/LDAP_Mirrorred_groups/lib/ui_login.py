...
class FWPage(Browser):
    ...
    def login_ui(self):
        try:       
            ...
            time.sleep(10)
            logger.info("Action - Clicked Device")
            ...
            time.sleep(5)
            logger.info("Action - Clicked Ldap Configure")
            self.click_element('xpath', "//span[normalize-space()='Users & Groups']")
            time.sleep(5)
            logger.info("Action - Clicked Users & Groups")
            ...
            time.sleep(5)
            logger.info("Action - Clicked disable Mirrored group")
            self.click_element('xpath', "//button[normalize-space()='Yes']")
            time.sleep(5)
            logger.info("Action - Clicked yes")
            self.click_element('xpath', "//button[normalize-space()='Apply']")
            time.sleep(5)
            logger.info("Action - Clicked apply")
            self.click_element('xpath', "//button[@class='sw-button sw-button--light users-settings-config-ldap__ldap-cancel']")
            time.sleep(5)
            logger.info("Action - Clicked Cancel")
            self.click_element('xpath', "//span[normalize-space()='Local Users & Groups']")
            time.sleep(5)
            logger.info("Action - Clicked Local users")
            resp = self.does_page_have_text("Mirrored Groups")
            Assertion.assert_equal(resp, False, "ERR: Mirreord group is not disabled")
            time.sleep(5)
