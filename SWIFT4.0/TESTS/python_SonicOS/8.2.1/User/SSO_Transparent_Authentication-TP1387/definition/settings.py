...
sys.path.append(os.environ["PYTHON_SONICOS_HOME"] +'/User/SSO_Transparent_Authentication-TP1387/definition')
...
class Parameter():
    ...
    TESTPLAN = os.environ["PYTHON_SONICOS_HOME"] + '/User/SSO_Transparent_Authentication-TP1387/testplan/testplan.json'
...
user = "admin" 
pwd = G_PASSWORD_NEW
firewallUI = FWPage(url, user, pwd)
