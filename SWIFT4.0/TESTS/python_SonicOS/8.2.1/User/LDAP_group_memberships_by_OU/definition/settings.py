...
sys.path.append(os.environ["PYTHON_SONICOS_HOME"] + '/User/LDAP_group_memberships_by_OU/definition')
...
from lib.modules.API import system as system_api_as
...
class Parameter:
    ...
    TESTPLAN = os.environ["PYTHON_SONICOS_HOME"] + '/User/LDAP_group_memberships_by_OU/testplan/testplan.json'

ca_cert = os.environ["PYTHON_SONICOS_HOME"] + '/User/LDAP_group_memberships_by_OU/definition/root_cert.cer'
...
settingObj = system_api_as.SettingApi(fw_api)
system_api = system_api_as.DiagnosticApi(fw_api)
