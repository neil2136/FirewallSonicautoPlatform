...
# from definition.SAML_API import SAMLApi, SAMLCli
...
TESTPLAN = suite_path + 'testplan/saml_management.json'
...
locate_profile_expand = ['xpath',
                                 '//div[text()="profile_https"]/parent::*/preceding-sibling::div[contains(@class, "sw-table-row__cell")]/div[contains(@class, "sw-table-row__cell__wrapper")]']