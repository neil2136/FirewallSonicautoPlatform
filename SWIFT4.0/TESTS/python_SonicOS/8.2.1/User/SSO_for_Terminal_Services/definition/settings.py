...
sys.path.append(os.environ["PYTHON_SONICOS_HOME"] +'/User/SSO_for_Terminal_Services/definition')

from lib.modules.CLI.system import LicenseCli
from lib.modules.API.network import InterfaceIPv4Api
from lib.modules.API.users import UsersettingApi, UserStatusApi
from lib.modules.API.system import PacketmonitorApi
from lib.modules.API.accessrule import AccessRuleIPv4Api
from lib.modules.API.system import RestartApi, DiagnosticApi, StatusApi
...
class Parameter():
    ...
    TESTPLAN = os.environ["PYTHON_SONICOS_HOME"] + '/User/SSO_for_Terminal_Services/testplan/testplan.json'
