...
sys.path.append(os.environ["PYTHON_SONICOS_HOME"] + '/User/LDAP_Mirrorred_groups_2/lib')
...
class Parameter():
    ...
    X1_IP = '13.0.0.100'
    X1_GW = '13.0.0.1'
    TESTPLAN = os.environ["PYTHON_SONICOS_HOME"] + '/User/LDAP_Mirrorred_groups_2/testplan/ldap_mirrored_groups.json'
