...
class Parameter():
    ...
    HTTP_CONFS_PATH = os.environ["PYTHON_SONICOS_HOME"] + '/User/Ula_TP88_3/definition/config/httpserver'
...
remote_vpn_dmz = {
    ...
    "name": "remote_vpn_dmz",
    "zone": "VPN",
    "value": Parameter.X2_SUBNET+','+Parameter.MASK,
}
remote_wan_host = {
    "object_type": "host",
    "name": "remote_wan_host",
    "zone": "VPN",
    "value": Parameter.WAN_IP
}
local_group = {
    "name": "local_group",
    "version": "ipv4",
    "objects": ['ipv4 "X0 Subnet"', 'ipv4 "X2 Subnet"', 'ipv4 ' + local_wan_host['name']]
}
remote_group = {
    "name": "remote_group",
    "version": "ipv4",
    "objects": ['ipv4 ' + remote_vpn_lan['name'], 'ipv4 ' + remote_vpn_dmz['name'], 'ipv4 ' + remote_wan_host['name']]
}
