...
sys.path.append(os.environ["PYTHON_SONICOS_HOME"] +'/User/SSO_Transparent_Authentication-TP1387_2/definition')
...
from lib.modules.API.system import DiagnosticApi, RestartApi, AdminApi
...
from lib.modules.API.securityservices import IPSApi, AntiSpywareApi, AppControl
...
class Parameter():
    ...
    TESTPLAN = os.environ["PYTHON_SONICOS_HOME"] + '/User/SSO_Transparent_Authentication-TP1387_2/testplan/testplan.json'
...
appcontrol_api = AppControl(fw_api)
