...
sys.path.append(os.environ["PYTHON_SONICOS_HOME"] + '/User/LDAP_TP293_2/definition')
...
class Parameter:
    ...
    TESTPLAN = os.environ["PYTHON_SONICOS_HOME"] + '/User/LDAP_TP293_2/testplan/ldap_testplan.json'

ca_cert = os.environ["PYTHON_SONICOS_HOME"] + '/User/LDAP_TP293_2/definition/root_cert.cer'
