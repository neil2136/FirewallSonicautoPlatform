...
sys.path.append(os.environ["PYTHON_SONICOS_HOME"] + '/User/LDAP_TP293_1/lib')
import ui_ldap
...
class Parameter():
    ...
    X1_IP = '13.0.0.100'
    X1_GW = '13.0.0.1'
    TESTPLAN = os.environ["PYTHON_SONICOS_HOME"] + '/User/LDAP_TP293_1/testplan/ldap_testplan.json'
