...
sys.path.append(os.environ["PYTHON_SONICOS_HOME"] + '/User/local_groups_smoke2/lib')
...
tc_path = os.environ["PYTHON_SONICOS_HOME"] + '/User/local_groups_smoke2/testcases'
lib_path = os.environ["PYTHON_SONICOS_HOME"] + '/User/local_groups_smoke2/lib'
...
class Parameter():
    ...
    X1_IP = '13.0.0.100'
    X1_GW = '13.0.0.1'
    TESTPLAN = os.environ["PYTHON_SONICOS_HOME"] + '/User/local_groups_smoke2/testplan/local_groups_testplan.json'
