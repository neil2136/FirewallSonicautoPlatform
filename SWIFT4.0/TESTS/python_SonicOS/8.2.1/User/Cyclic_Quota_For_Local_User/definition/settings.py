...
from lib.modules.API import network, firewall,users, log
...
TESTPLAN = os.environ["PYTHON_SONICOS_HOME"] + '/User/Cyclic_Quota_For_Local_User/testplan/cyclic_quota_local_user.json'
...
r_fw_api = Firewall(R_X1_IP, user='admin', password='sonicauto', supported_config_mode='api')
r_fw_cli = Firewall(R_X1_IP, user='admin', password='sonicauto', supported_config_mode='cli-ssh')
