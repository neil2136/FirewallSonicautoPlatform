...
def fill_in_user_info_part(user=Parameter.USER1):
    ...
    if fw_page_ui.does_element_exist('xpath', '//div[text()="Enter password"]'):
        ...
        fw_page_ui.set_text_field('xpath', '//input[@type="password"]', Parameter.PWD)
        time.sleep(3)
...
def saml_user_ula_login(user=Parameter.USER1):
    rc = False
    auth_page = False
