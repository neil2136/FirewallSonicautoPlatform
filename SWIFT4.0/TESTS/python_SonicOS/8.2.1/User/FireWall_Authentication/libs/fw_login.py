...
class FWLogin(Browser):
    def __init__(self, url, username, password):
        self.url = url
        self.username = username
        self.password = password

    # Log in to Firewall with Username/Password
    def fw_unpw_login(self, expected_failure=False):
        try:
            self.get_browser()
            ...
            if expected_failure:
                ...
                logger.info("Firewall login Successful...")
            ...
            logger.error("Firewall login failed...")

    # Login to FireWall with TOTP
    def fw_login_with_totp(self, expected_failure=False):
        try:
            res_obj = DEVMODE()
            ...
            if expected_failure:
                ...
                # Verifying FireWall has landed successfully into Home Page
                self.wait_for_text("Home")
                logger.info("Firewall login with TOTP is successful...")
                self.click_element('class', 'sw-avatar__initials')
                self.click_element('xpath', '/html/body/div[2]/div[1]/div[1]/div[1]/div/div/div/div[4]/span/span')
                self.wait_for_text("Do you want to continue logout?")
                self.click_element('xpath', '/html/body/div[2]/div/div/div[2]/div/div[2]/button')
            ...
            logger.error("Exception \t: " + str(err))
            logger.error("Firewall login with TOTP failed...")

    # Login to FireWall with Mail OTP
    def fw_login_with_mail_otp(self, expected_failure=False):
        try:
            self.get_browser()
            self.maximize_window()
            self.go_to_url(self.url)
            ...
            if expected_failure:
                ...
                self.click_element('xpath', '/html/body/div/div/div/div/div[3]/div/div[2]/button')
                # Verifying that mail OTP is successfully validated and clicking on Continue
                self.wait_for_text('Your password has been verified.')
                self.click_element('xpath', '/html/body/div/div/div/div/div[3]/div/div/button')
                self.close_auto_upgrade_notification()
                # Verifying FireWall has landed successfully into Home Page
                self.wait_for_text("Home")
                logger.info("Firewall login with Mail OTP is successful...")
                self.click_element('class', 'sw-avatar__initials')
                self.click_element('xpath', '/html/body/div[2]/div[1]/div[1]/div[1]/div/div/div/div[4]/span/span')
                self.wait_for_text("Do you want to continue logout?")
                self.click_element('xpath', '/html/body/div[2]/div/div/div[2]/div/div[2]/button')
            ...
            logger.error("Exception \t: " + str(err))
            logger.error("Firewall login with Mail OTP failed...")

    # Enabling "HTTP Basic Access authentication" which enables to use API to configure the FireWall.
    def fw_enable_http_basic_access_authentication(self):
        try:
            self.get_browser()
            self.maximize_window()
            self.go_to_url(self.url)
            ...
            self.go_to_url(self.url)
            self.close_auto_upgrade_notification()
            self.click_element('xpath', '/html/body/div/div/div/div[2]/div[4]/div[2]/div[1]/div/section/'
                                        'div/div[1]/div[1]/div/div[2]/div[1]/div/ul/li[3]/div/span')
            self.wait_for_text("RFC-2617 HTTP Basic Access authentication")
            toggle_button = self.browser.find_element(By.XPATH, '/html/body/div/div/div/div[2]/div[4]/div[2]/div[1]/'
                                                                'div/section/div/div[1]/div[2]/div/div/div/div/div[2]/'
                                                                'div/div[1]/div/div[12]/div/div[2]/div')
            toggle_class = toggle_button.get_attribute('class')
            if 'sw-toggle--off' in toggle_class:
                logger.info("'HTTP Basic Access authentication' Toggle button is disabled, enabling it...")
                self.click_element('xpath', '/html/body/div/div/div/div[2]/div[4]/div[2]/div[1]/div/section/div/div[1]/'
                                            'div[2]/div/div/div/div/div[2]/div/div[1]/div/div[12]/div/div[2]/div')
                self.click_element('xpath', '/html/body/div/div/div/div[2]/div[4]/div[2]/div[1]/div/section/div/div[2]/'
                                            'div/div/div[2]/span/div/div/button')
                logger.info("Enabled 'HTTP Basic Access authentication'...")
            else:
                logger.info("'HTTP Basic Access authentication' is already enabled...")
            self.click_element('class', 'sw-avatar__initials')
            self.click_element('xpath', '/html/body/div[2]/div[1]/div[1]/div[1]/div/div/div/div[4]/span/span')
            self.wait_for_text("Do you want to continue logout?")
            self.click_element('xpath', '/html/body/div[2]/div/div/div[2]/div/div[2]/button')
            ...
            logger.error("Exception \t: " + str(err))
            logger.error("Unable to enable 'HTTP Basic Access authentication'...")
