...
# from definition import ui_user

suite_path = os.environ["PYTHON_SONICOS_HOME"] + '/User/Ula_TP88/'
sys.path.append(suite_path)
sys.path.append(suite_path + 'testcases')

TESTPLAN = os.environ["PYTHON_SONICOS_HOME"] + '/User/Ula_TP88/testplan/ula.json'
