...
sys.path.append(os.environ["PYTHON_SONICOS_HOME"] +'/User/User_Status/definition')
sys.path.append(os.environ["PYTHON_SONICOS_HOME"] + '/User/User_Status/testcases')
...
class Parameter():
    ...
    X1_IP = '13.0.0.10'
    X1_GW = '13.0.0.1'
    TESTPLAN = os.environ["PYTHON_SONICOS_HOME"] + '/User/User_Status/testplan/testplan.json'
