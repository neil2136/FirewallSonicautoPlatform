...
sys.path.append(os.environ["PYTHON_SONICOS_HOME"] + '/Log/Log_Monitor_New_TP2582/testcases')
sys.path.append(os.environ["PYTHON_SONICOS_HOME"] + '/Log/Log_Monitor_New_TP2582')
sys.path.append(os.environ["PYTHON_SONICOS_HOME"] + '/Log/Log_Monitor_New_TP2582/lib/')
print(sys.path)
import pop3_client
...
X2_IP = '14.1.1.168'
MASK = '255.255.255.0'
TESTPLAN = os.environ["PYTHON_SONICOS_HOME"] + '/Log/Log_Monitor_New_TP2582/testplan/Log_Monitor_New_TP2582.json'
config_path = os.environ["PYTHON_SONICOS_HOME"] + "/Log/Log_Monitor_New_TP2582/config"
ip = FIREWALL
