...
class Parameter:
    ...
    PC3_IP = '12.12.1.130'
    CONF_PATH = os.environ["PYTHON_SONICOS_HOME"] + '/CLI/SSL_VPN_and_Virtual_Assist/definition/config'
    TESTPLAN = os.environ["PYTHON_SONICOS_HOME"] + '/CLI/SSL_VPN_and_Virtual_Assist/testplan/testplan.json'
...
pc2 = Host(static_pc)
start_mail_server = StartMailServer(pc1, Parameter.postfix_1k_path, Parameter.dovecot_1k_path,
                                    Parameter.mail_server_path + 'vsftpd_1k.key',
                                    Parameter.mail_server_path + 'vsftpd_1k.crt')
