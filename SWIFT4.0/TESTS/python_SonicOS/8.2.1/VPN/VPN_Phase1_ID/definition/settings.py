...
sys.path.append(os.environ["PYTHON_SONICOS_HOME"] + 'VPN/VPN_Phase1_ID')
sys.path.append(os.environ["PYTHON_SONICOS_HOME"] + 'VPN/VPN_Phase1_ID/definition')
...
from definition import get_fwid
...
TESTPLAN = os.environ["PYTHON_SONICOS_HOME"]+'/VPN/VPN_Phase1_ID/testplan/VPN_Phase1_ID.json'


local_fwid = 'ABCDEFGH1234'
remote_fwid = '1234ABCDEFG'
