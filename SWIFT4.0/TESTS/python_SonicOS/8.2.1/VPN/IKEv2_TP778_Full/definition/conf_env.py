...
class TestConfigTB(Test):
    ...
    def test_00_02_Add_DUT_AddObj(self):
        ...
        rc &= LAddrOBJ.config_addressobject(**remote_l2)
    ...
    # def test_00_03_set_FW_time(self):
    #     time_json = {
    #         "time": {
    #             "use_ntp": False,
    #             "time": "00:00:00",
    ...
    def test_00_04_Add_CA_Cert_for_DUT(self):
    ...
    def test_00_05_Add_CA_Cert_for_Remote(self):
