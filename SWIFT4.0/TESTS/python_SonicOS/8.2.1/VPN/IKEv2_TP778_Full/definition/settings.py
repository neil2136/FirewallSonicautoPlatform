...
ts_path = os.environ["PYTHON_SONICOS_HOME"] + '/VPN/IKEv2_TP778_Full'
TESTPLAN = os.environ["PYTHON_SONICOS_HOME"]+'/VPN/IKEv2_TP778_Full/testplan/IKEv2_TP778.json'
