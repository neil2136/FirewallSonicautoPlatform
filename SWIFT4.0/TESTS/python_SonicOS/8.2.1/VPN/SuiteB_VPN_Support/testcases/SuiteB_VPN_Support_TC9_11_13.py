...
@paramunittest.parametrized(
    ...
    {'ike_exchange': 'main', 'ike_dh_group': '21', 'ipsec_encryption': 'aes_128', 'ipsec_pfs_dhgroup': 21,\
         'test_log': False, 'uuid': '1515021', 'tcid': '31'},
    {'ike_exchange': 'aggressive', 'ike_dh_group': '25', 'ipsec_encryption': 'aes_128', 'ipsec_pfs_dhgroup': 25,\
         'test_log': False, 'uuid': '1515021', 'tcid': '31'},
    {'ike_exchange': 'ikev2', 'ike_dh_group': '26', 'ipsec_encryption': 'aes_128', 'ipsec_pfs_dhgroup': 26,\
         'test_log': False, 'uuid': '1515021', 'tcid': '31'},
 )
class TestSuiteB_VPN_Support_09_11_13(Test):
    ...
    def test_01_02_add_vpn_policy(self):
        ref1 = copy.deepcopy(Lvpn_TI_presh)
        ref2 = copy.deepcopy(Rvpn_TI_presh)
    ...
    def test_01_06_remove_vpn_policy(self):
        ...
        rc1 = Lvpn_obj.del_tunnelvpn_policy(**Lvpn_TI_presh)
        rc2 = Rvpn_obj.del_tunnelvpn_policy(**Rvpn_TI_presh)
