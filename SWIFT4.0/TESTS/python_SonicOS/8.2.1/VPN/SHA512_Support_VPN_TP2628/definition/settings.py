...
TESTPLAN = os.environ["PYTHON_SONICOS_HOME"]+'/VPN/SHA512_Support_VPN_TP2628/testplan/SHA512_Support_VPN_TP2628.json'
ca_cert = os.environ["PYTHON_SONICOS_HOME"]+'/VPN/SHA512_Support_VPN_TP2628/cert/rootca.pem'
local_cert =os.environ["PYTHON_SONICOS_HOME"]+'/VPN/SHA512_Support_VPN_TP2628/cert/my_cert.pfx'
#show cert cmds
