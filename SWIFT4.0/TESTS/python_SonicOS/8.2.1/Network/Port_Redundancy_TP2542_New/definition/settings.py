...
sys.path.append(os.environ["PYTHON_SONICOS_HOME"] + 'Network/Port_Redundancy_TP2542_New/testcases')
...
# define path
TESTPLAN = os.environ["PYTHON_SONICOS_HOME"]+'/Network/Port_Redundancy_TP2542_New/testplan/Port_Redundancy_TP2542.json'
