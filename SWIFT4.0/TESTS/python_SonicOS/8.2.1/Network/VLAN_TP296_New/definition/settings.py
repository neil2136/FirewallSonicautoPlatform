...
sys.path.append(
    ...
    'Network/VLAN_TP296_New/testcases')
sys.path.append(
    os.environ["PYTHON_SONICOS_HOME"] +
    'Network/VLAN_TP296_New/definition')
scripts_path = os.environ["PYTHON_SONICOS_HOME"] + \
               '/Network/VLAN_TP296_New/definition/scripts/'
...
class Parameter:
    ...
    TESTPLAN = os.environ["PYTHON_SONICOS_HOME"] + \
               '/Network/VLAN_TP296_New/testplan/vlan_tp296.json'
