...
sys.path.append(os.environ["PYTHON_SONICOS_HOME"] + 'Network/PPTP_Client/testcases')
...
confs_path = os.environ["PYTHON_SONICOS_HOME"] + '/Network/PPTP_Client/confs/'
...
class Parameter():
    ...
    X2_IP = '14.1.1.168'
    MASK = '255.255.255.0'
    TESTPLAN = os.environ["PYTHON_SONICOS_HOME"] + '/Network/PPTP_Client/testplan/PPTP_Client.json'
