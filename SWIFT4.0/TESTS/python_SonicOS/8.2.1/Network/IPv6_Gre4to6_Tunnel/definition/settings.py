...
sys.path.append(os.environ['PYTHON_SONICOS_HOME'])
suite_path = os.environ['PYTHON_SONICOS_HOME'] + '/Network/IPv6_Gre4to6_Tunnel/'
sys.path.append(suite_path)
sys.path.append(suite_path + 'testcases')
TESTPLAN = suite_path + 'testplan/ipv6_gre4to6_tunnel.json'
