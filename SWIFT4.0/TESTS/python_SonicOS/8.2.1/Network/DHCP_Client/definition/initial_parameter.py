...
sys.path.append(os.environ["PYTHON_SONICOS_HOME"] + 'Network/DHCP_Client/testcases')
...
bin_path = os.environ["PYTHON_SONICOS_HOME"] + '/Network/DHCP_Client/bin/'
...
class Parameter():
    ...
    X2_IP = '14.1.1.168'
    MASK = '255.255.255.0'
    TESTPLAN = os.environ["PYTHON_SONICOS_HOME"] + '/Network/DHCP_Client/testplan/DHCP_Client.json'
