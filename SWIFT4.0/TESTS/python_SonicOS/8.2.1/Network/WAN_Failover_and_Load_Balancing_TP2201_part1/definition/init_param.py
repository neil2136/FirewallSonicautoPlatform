...
sys.path.append(os.environ['PYTHON_SONICOS_HOME'] + '/Network/WAN_Failover_and_Load_Balancing_TP2201_part1/testcases')
...
class Parameter():
    ...
    TESTPLAN = os.environ['PYTHON_SONICOS_HOME'] + '/Network/WAN_Failover_and_Load_Balancing_TP2201_part1/testplan/WAN_Failover_and_Load_Balancing_TP2201.json'
...
TESTPATH= os.environ['PYTHON_SONICOS_HOME']  + '/Network/WAN_Failover_and_Load_Balancing_TP2201_part1'
