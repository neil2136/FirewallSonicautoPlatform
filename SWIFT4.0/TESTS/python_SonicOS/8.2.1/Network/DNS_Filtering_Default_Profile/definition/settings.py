...
class Parameter():
    ...
    TEST_Path = os.environ["PYTHON_SONICOS_HOME"] + '/Network/DNS_Filtering_Default_Profile'
    TESTPLAN = TEST_Path + '/testplan/DNS_Filtering_Default_Profile.json'
...
cmds_06 = [
    ...
    'category 2.\ Gaming forge-ip-reply',
    'commit',
    'end',
    'exit'
]
