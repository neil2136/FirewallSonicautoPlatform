from definition.settings import Parameter, PC1_LOGIN, packet_api, logMonitor_api, time, re, logger
...
def check_dns_packets_in_tShark(tCmd: str, target: tuple or str):
