...
suite_path = os.environ["PYTHON_SONICOS_HOME"] + '/Network/Transparent_Mode_TP270_part2/'
sys.path.append(suite_path)
sys.path.append(suite_path + 'testcases')
TESTPLAN = suite_path + 'testplan/Transparent_Mode_TP270.json'
...
x3_transparent_dict = {
    'if': 'X3',
    'comment': 'auto_transmode_test_x3',
    'zone': 'LAN',
    'mode': 'transparent',
    'transparent_range': {'name': PC4_ETH1_IP},
    'gratuitous_arp_wan_forwarding': False,
