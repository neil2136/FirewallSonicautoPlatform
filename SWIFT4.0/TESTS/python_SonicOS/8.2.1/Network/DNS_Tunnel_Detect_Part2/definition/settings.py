...
suite_path = os.environ['PYTHON_SONICOS_HOME']+'/Network/DNS_Tunnel_Detect_Part2/'
sys.path.append(suite_path)
sys.path.append(suite_path+'testcases')
TESTPLAN = suite_path+'testplan/dns_tunnel_detect_part2.json'
...
dnssecurityapi = network.DNSSecurityApi(fw)
zoneapi = network.ZoneObjectsApi(fw)
