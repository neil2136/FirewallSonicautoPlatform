...
if 'RemoteGEN7' in node_list:
    rm_device = 'RemoteGEN7'
elif 'RemoteGEN5' in node_list:
    rm_device = 'RemoteGEN5'
else:
    rm_device = None
...
VPN_bin = os.environ["PYTHON_SONICOS_HOME"] + '/Network/WAN_Failover_and_Load_Balancing_TP2201_part2/bin'
...
if 'PC3' in node_list:
    ...
    # DNS_Server_login = Host(PC3_IP, user='root', password='password')
...
if 'PC5' in node_list:
    ...
    # PC5_login = Host(PC5_IP, user='root', password='password')
