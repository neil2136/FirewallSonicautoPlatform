...
from lib.modules.API.network import AddressobjectsApi, InterfaceIPv4Api, InterfaceIPv6Api, RoutePolicyApi
...
PC_GW5_ETH1_IP = os_obj.get_node_interface_ip('PC-GW5', 'eth1')
PC_GW5_ETH1_IPV6 = os_obj.get_node_interface_ipv6('PC-GW5', 'eth1')
PC_GW5_ETH2_IP = os_obj.get_node_interface_ip('PC-GW5', 'eth2')
PC_GW5_ETH2_IPV6 = os_obj.get_node_interface_ipv6('PC-GW5', 'eth2')
PC_GW5_ETH3_IP = os_obj.get_node_interface_ip('PC-GW5', 'eth3')
...
logger.info(f"\n PC_Server_ETH1_IP : {PC_Server_ETH1_IP}"
            ...
            + f"\n PC_GW5_ETH1_IP : {PC_GW5_ETH1_IP}"
            + f"\n PC_GW5_ETH1_IPV6 : {PC_GW5_ETH1_IPV6}"
            + f"\n PC_GW5_ETH2_IP : {PC_GW5_ETH2_IP}"
            + f"\n PC_GW5_ETH2_IPV6 : {PC_GW5_ETH2_IPV6}"
            + f"\n PC_GW5_ETH3_IP : {PC_GW5_ETH3_IP}"
            )
...
PC_GW5_Login = Host(PC_GW5_ETH3_IP)
...
class Parameter:
    ...
    X3_IP = "13.0.13.168"
    X3_MASK = "255.255.255.0"
    X3_IPV6 = "2001:2013::168"
    X4_IP = "13.0.14.168"
    X4_MASK = "255.255.255.0"
    X4_IPV6 = "2001:2014::168"
    X5_IP = "13.0.15.168"
    X5_MASK = "255.255.255.0"
    X5_IPV6 = "2001:2015::168"

    PREFIX_LENGTH = 64

    GW1_IP = PC_GW1_ETH2_IP
    GW2_IP = PC_GW2_ETH2_IP
    GW3_IP = PC_GW3_ETH2_IP
    GW4_IP = PC_GW4_ETH2_IP
    GW5_IP = PC_GW5_ETH2_IP
    GW1_MAC = ''
    GW2_MAC = ''
    GW3_MAC = ''
    GW4_MAC = ''
    GW5_MAC = ''
    GW1_IPV6 = PC_GW1_ETH2_IPV6[:-3]
    GW2_IPV6 = PC_GW2_ETH2_IPV6[:-3]
    GW3_IPV6 = PC_GW3_ETH2_IPV6[:-3]
    GW4_IPV6 = PC_GW4_ETH2_IPV6[:-3]
    GW5_IPV6 = PC_GW5_ETH2_IPV6[:-3]
