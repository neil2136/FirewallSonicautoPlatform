...
sys.path.append(os.environ['PYTHON_SONICOS_HOME'] + '/Network/Unbounded_Multiple_WAN_Support_TP2423/testcases')
...
class Parameter():
    ...
    TESTPLAN = os.environ['PYTHON_SONICOS_HOME'] + '/Network/Unbounded_Multiple_WAN_Support_TP2423/testplan/Unbounded_Multiple_WAN_Support_TP2423.json'
...
PC_Server_ETH2_IP = os_obj.get_node_interface_ip('PC_Server','eth2')
PC_Server_ETH3_IP = os_obj.get_node_interface_ip('PC_Server','eth3')
...
TESTPATH= os.environ['PYTHON_SONICOS_HOME']  + '/Network/Unbounded_Multiple_WAN_Support_TP2423'


binPath = os.environ["PYTHON_SONICOS_HOME"] + '/Network/Unbounded_Multiple_WAN_Support_TP2423/bin'
toolPath = os.environ["PYTHON_COMMON_HOME"] + '/util/dpissh/tools'

IP_Server = '100.100.10.200'
Server_MGMT = '172.168.0.200'
IP_Responser_SNWL = IP_Server
Host_Responser_SNWL = IP_Server
