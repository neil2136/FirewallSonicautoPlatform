...
sys.path.append(os.environ["PYTHON_SONICOS_HOME"] +'/Network/IPsec_IPV6_VPN_Api')
sys.path.append(os.environ["PYTHON_SONICOS_HOME"] +'/Network/IPsec_IPV6_VPN_Api/definition')
...
class Parameter():
    ...
    X1_IP = '13.0.0.10'
    X1_GW = '13.0.0.1'
    TESTPLAN = os.environ["PYTHON_SONICOS_HOME"] + '/Network/IPsec_IPV6_VPN_Api/testplan/ipsec_vpn.json'
