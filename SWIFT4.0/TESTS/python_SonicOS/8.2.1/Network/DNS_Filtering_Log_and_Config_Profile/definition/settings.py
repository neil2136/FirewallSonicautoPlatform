...
class Parameter():
    ...
    TEST_Path = os.environ["PYTHON_SONICOS_HOME"] + '/Network/DNS_Filtering_Log_and_Config_Profile'
    TESTPLAN = TEST_Path + '/testplan/DNS_Filtering_Log_and_Config_Profile.json'
